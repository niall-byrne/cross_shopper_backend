...
import pytest
from items.admin.inlines.price_group import item, price_group_attribute
...
@pytest.fixture
def price_group_item_inline(
    mocked_admin_site: mock.Mock,
    mocked_model: mock.Mock,
) -> item.PriceGroupItemInline:
  return item.PriceGroupItemInline(
      parent_model=mocked_model,
      admin_site=mocked_admin_site,
  )
