...
class TestReportPricingSerializerSerializer:
  ...
  def test_serialization__with_pricing__correct_representation(
    ...
    mocked_aggregate_last_52_weeks_manager.average.return_value = decimal.Decimal(
        "10.50"
    )
    mocked_aggregate_last_52_weeks_manager.high.return_value = decimal.Decimal(
        "20.50"
    )
    mocked_aggregate_last_52_weeks_manager.low.return_value = decimal.Decimal(
        "1.50"
    )
