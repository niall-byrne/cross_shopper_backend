"""Tests for the column_generator function."""
...
class TestColumnGenerator:
  ...
  def test_single_configuration__sets_the_correct_method_name(
    ...
    column_generator(mocked_admin)(config=column_config_1)
  ...
  def test_dual_configuration__sets_the_correct_method_names(
    ...
    column_generator(mocked_admin)(config=column_config_2)
  ...
  def test_boolean_configuration__sets_the_correct_method_name(
    ...
    column_generator(mocked_admin)(config=column_config_3)
