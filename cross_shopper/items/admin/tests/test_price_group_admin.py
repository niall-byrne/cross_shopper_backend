...
class TestPriceGroupAdmin:
  ...
  def test_instantiate__has_correct_fields(
    ...
    assert price_group_admin.fields == (
        'name',
        'quantity',
        'unit',
        'members',
  ...
  def test_instantiate__has_correct_ordering(
    ...
    assert price_group_admin.ordering == ('name', 'unit__name', 'quantity')

  def test_instantiate__has_readonly_fields(
      self,
      price_group_admin: PriceGroupAdmin,
  ) -> None:
    assert price_group_admin.readonly_fields == ('members',)
