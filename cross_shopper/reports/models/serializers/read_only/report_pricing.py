...
class ReportPricingSerializerRO(serializers.ModelSerializer[Item]):
  ...
  def get_last_52_weeks_average(self, instance: Item) -> str | None:
  ...
  def get_last_52_weeks_high(self, instance: Item) -> str | None:
  ...
  def get_last_52_weeks_low(self, instance: Item) -> str | None:
