...
class TestPricingViewSetCreateNoAuthentication:
  """Test the PricingViewSet create view without authentication."""
...
@pytest.mark.django_db
class TestPricingViewSetAuthentication:
  """Test the PricingViewSet create view with authentication."""
