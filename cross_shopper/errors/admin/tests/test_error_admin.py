...
class TestErrorAdmin:
  ...
  def test_instantiate__inheritance(self, error_admin: ErrorAdmin) -> None:
  ...
  def test_instantiate__actions(self, error_admin: ErrorAdmin) -> None:
  ...
  def test_instantiate__list_filter(self, error_admin: ErrorAdmin) -> None:
    assert error_admin.list_filter == filters.error_filter
